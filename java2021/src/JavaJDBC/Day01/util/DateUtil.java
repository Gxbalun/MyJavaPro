...
public class DateUtil {
    ...
    public static void main(String[] args) throws ParseException {
      //  DateUtil.stringToDate("2020-11-13","yyyy-MM-dd");
        System.out.println(DateUtil.dateToString(new Date(),"yyyy/MM/dd"));
        System.out.println(DateUtil.dateToString("yyyy/MM/dd HH:mm:ss"));
        System.out.println(DateUtil.dateToString("yyyyMMddHHmmss"));
