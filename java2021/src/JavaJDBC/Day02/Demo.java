...
public class Demo {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            /*int res = st.executeUpdate("update student set sex ='"+sex+"',grade_id ="+gradeId+" where num=6");
            System.out.println(res);*/

            int res1 = st.executeUpdate("delete from student_course where stu_num=6");
            int res2 = st.executeUpdate("delete from student where stu_num = 6");
